<div>
    ...
    <head>
        ...
        <title>Tin tức - Công Ty TNHH Phân Bón Quốc Tế Rồng Xanh</title>
        <link rel="stylesheet" href="/assets/wp-content/cache/min/1/2238ce73209544a4b7d44ee8c180fe0f.css" media="all"
            data-minify="1" />
        ...
        <link rel="alternate" type="application/json" href="/assets/wp-json/wp/v2/categories/4" />
...
*/
    ...
    <body
        class="archive category category-tin-tuc category-4 wp-custom-logo theme-flatsome everest-forms-no-js woocommerce-no-js woo-variation-swatches wvs-behavior-blur wvs-theme-flatsome wvs-show-label wvs-tooltip full-width lightbox nav-dropdown-has-arrow mobile-submenu-toggle wpb-js-composer js-comp-ver-6.2.0 vc_responsive">
                    ...
                    <div class="row align-center">
                        <div class="large-10 col">
                            ...
                            <div class="row large-columns-3 medium-columns-2 small-columns-1">
                                @foreach ($newsList as $item) <!-- Giả định $newsList là danh sách bài viết -->
                                    <div class="col post-item">
                                        <div class="col-inner">
                                            <a href="{{ route('news.detail', ['slug' => $item->slug]) }}" class="plain">
                                                <div class="box box-text-bottom box-blog-post has-hover">
                                                    <div class="box-image">
                                                        <div class="image-cover" style="padding-top:56%;">
                                                            <img width="2001" height="1330"
                                                                src="{{ '/storage/' . $item->anh }}"
                                                                class="attachment-medium size-medium wp-post-image"
                                                                alt="{{ $item->ten }}" decoding="async"
                                                                data-lazy-sizes="(max-width: 2001px) 100vw, 2001px"
                                                                title="{{ $item->ten }}">
                                                            <noscript>
                                                                <img width="2001" height="1330"
                                                                    src="{{ '/storage/' . $item->anh }}"
                                                    ...
                                                    <div class="box-text text-left">
                                                        <div class="box-text-inner blog-post-inner">
                                                            <h5 class="post-title is-large">{{ $item->ten }}</h5>
                                                            <div class="is-divider"></div>
                                                            <p class="from_the_blog_excerpt">
                                                                {{ Str::limit($item->short_description, 100) }}</p>
                                                        </div>
                                                    </div>
                    ...
                    <form class="woocommerce-form woocommerce-form-login login" method="post">
                        ...
                        <p class="form-row">
                            ...
                            <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce"
                                value="8613c8747b" /><input type="hidden" name="_wp_http_referer" value="/tin-tuc/" />
...
<![endif]-->
        ...
        <script type="rocketlazyloadscript" id="gt_widget_script_25567283-js-before" data-rocket-type="text/javascript">
window.gtranslateSettings = /* document.write */ window.gtranslateSettings || {};window.gtranslateSettings['25567283'] = {"default_language":"vi","languages":["km","lo","vi"],"dropdown_languages":["km","lo","vi"],"url_structure":"none","add_new_line":1,"flag_style":"3d","flag_size":16,"wrapper_selector":"li.menu-item-gtranslate.gt-menu-43707","alt_flags":[],"horizontal_position":"inline","flags_location":"\/wp-content\/plugins\/gtranslate\/flags\/"};
</script>
        <script type="rocketlazyloadscript" src="/assets/wp-content/plugins/gtranslate/js/fd.js?ver=6.3"
            data-no-optimize="1" data-no-minify="1" data-gt-orig-url="/tin-tuc/" data-gt-orig-domain="ttpglobal.com.vn"
            data-gt-widget-id="25567283" defer></script> <input type="hidden"
            class="mystickyelement-country-list-hidden" value="" />
